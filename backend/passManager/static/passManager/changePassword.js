...
collapsibles[0].addEventListener("click", function () {
    ...
    var Updatebtn = document.getElementsByClassName("Updatebtns")[0];
    var input1 = document.getElementById("input1");
    if (menu.classList.contains('hidden')) {
        arrow.innerHTML = "&#707;";
        Heading.style.left = "2%";
        Updatebtn.style.left = "15%";
        input1.style.marginLeft = "5.5%";
    } else {
        arrow.innerHTML = "&#706;";
        Heading.style.left = "22%";
        Updatebtn.style.left = "22%";
        input1.style.marginLeft = "6%";
    }
});
...
for (var i = 0; i < eyeicons.length; i++) {
    eyeicons[i].addEventListener("click", function () {
        ...
        if (passwrd.getAttribute('type') === 'password') {
            ...
            this.innerHTML = `
            <path d="M2 2L22 22" stroke="#ffe66b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M6.71277 6.7226C3.66479 8.79527 2 12 2 12C2 12 5.63636 19 12 19C14.0503 19 15.8174 18.2734 17.2711 17.2884M11 5.05822C11.3254 5.02013 11.6588 5 12 5C18.3636 5 22 12 22 12C22 12 21.3082 13.3317 20 14.8335" stroke="#ffe66b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M14 14.2362C13.4692 14.7112 12.7684 15.0001 12 15.0001C10.3431 15.0001 9 13.657 9 12.0001C9 11.1764 9.33193 10.4303 9.86932 9.88818" stroke="#ffe66b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            `;
        } else {
            passwrd.setAttribute('type', 'password');
            this.innerHTML = `
            <g stroke="#ffe66b" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m15.0007 12c0 1.6569-1.3431 3-3 3-1.6568 0-2.99997-1.3431-2.99997-3s1.34317-3 2.99997-3c1.6569 0 3 1.3431 3 3z"/><path d="m12.0012 5c-4.47766 0-8.26794 2.94288-9.54222 7 1.27426 4.0571 5.06456 7 9.54222 7 4.4776 0 8.2679-2.9429 9.5422-7-1.2743-4.05709-5.0646-7-9.5422-7z"/></g>
            `;
        }
    });
}